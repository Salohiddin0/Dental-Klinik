...
import { Bluetooth as Tooth, Zap, Smile, Braces, Clock, DollarSign } from "lucide-react"
  ...
  const services = [
    {
      ...
      price: language === "ru" ? "от 15,000 ₸" : "15,000 ₸ dan",
    ...
    },
    {
      ...
      price: language === "ru" ? "от 180,000 ₸" : "180,000 ₸ dan",
    ...
    },
    {
      ...
      price: language === "ru" ? "от 45,000 ₸" : "45,000 ₸ dan",
    ...
    },
    {
      ...
      price: language === "ru" ? "от 250,000 ₸" : "250,000 ₸ dan",
      duration: language === "ru" ? "12-24 мес" : "12-24 oy",
      features:
        language === "ru"
          ? ["Металлические брекеты", "Керамические брекеты", "Невидимые элайнеры"]
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => {
            ...
            return (
              <Card
                key={index}
                className={`group hover:shadow-lg transition-all duration-300 relative ${service.popular ? "ring-2 ring-primary" : ""}`}
              >
                {service.popular && (
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                    <Badge className="bg-primary text-primary-foreground">
                      {language === "ru" ? "Популярно" : "Mashhur"}
                    </Badge>
                  </div>
                )}
        ...
        <div className="mt-16 text-center">
          <h3 className="text-2xl font-bold text-foreground mb-8">
            {language === "ru" ? "Дополнительные услуги" : "Qo'shimcha xizmatlar"}
          </h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              language === "ru" ? "Профессиональная чистка" : "Professional tozalash",
