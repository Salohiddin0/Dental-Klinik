  ...
  const teamMembers = [
    {
      ...
      position: language === "ru" ? "Главный врач, стоматолог-терапевт" : "Bosh shifokor, terapevt stomatolog",
      experience: language === "ru" ? "15 лет опыта" : "15 yil tajriba",
      education: language === "ru" ? "КазНМУ им. С.Д. Асфендиярова" : "S.D. Asfendiyarov nomidagi QazNMU",
      specializations:
        language === "ru"
    ...
    },
    {
      ...
      position: language === "ru" ? "Стоматолог-хирург, имплантолог" : "Stomatolog-jarroh, implantolog",
      experience: language === "ru" ? "12 лет опыта" : "12 yil tajriba",
      education: language === "ru" ? "Московский медицинский университет" : "Moskva tibbiyot universiteti",
      specializations:
        language === "ru"
    ...
    },
    {
      ...
      education: language === "ru" ? "СПбГМУ им. И.П. Павлова" : "I.P. Pavlov nomidagi SPbGMU",
      specializations:
        language === "ru"
    ...
    },
    {
      ...
      education: language === "ru" ? "Алматинский медицинский университет" : "Almaty tibbiyot universiteti",
      specializations:
        language === "ru"
    ...
    <section id="team" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4 text-balance">{t("team.title")}</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">{t("team.subtitle")}</p>
        </div>
                  ...
                  <div>
                    <div className="flex items-center mb-2">
                      ...
                      <span className="text-sm font-medium text-foreground">
                        {language === "ru" ? "Специализации:" : "Ixtisosliklar:"}
                      </span>
                    </div>
